...
-/
import KolmogorovArnold.Approximant
import KolmogorovArnold.RationalIndependence
import KolmogorovArnold.Superposition
import Mathlib.Topology.TietzeExtension

/-!
# Density of the approximation sets

Layer 2 of the Kolmogorov–Arnold development: the crux of the Baire-category proof. For a
continuous `f` on the cube with `‖f‖ ≤ 1`, the set `approxSet lam δ θ f` of tuples of inner
...
after reading both sources. The statement has had a best-effort read; the proofs have not been
read.
