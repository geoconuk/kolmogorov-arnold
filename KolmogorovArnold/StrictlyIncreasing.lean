...
the tuple can be taken strictly increasing at no further cost. This module proves that
...
further step to strictly increasing ones; the target statement's `StrictMono` rests on Kahane's
remark alone, and this module is where that remark is proved.
